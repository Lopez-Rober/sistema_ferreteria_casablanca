...
$('#tbTienda tbody').on('click', 'button[class="btn btn-sm btn-danger"]', function () {
    ...
    swal({
        title: "Mensaje",
        text: "¿Esta seguro de eliminiar la Sede?",
        type: "warning",
        ...
        AjaxPost("../frmTienda.aspx/Eliminar", JSON.stringify(request),
            function (response) {
                if (response.estado) {
                    ...
                    swal("oops!", "No se pudo eliminar la Sede", "warning")
                }
            },
            function () {
            },
            ...
            AjaxPost("../frmTienda.aspx/Guardar", JSON.stringify(request),
                function (response) {
                    ...
                    if (response.estado) {
                        ...
                        swal("Mensaje", "No se pudo registrar la Sede", "warning")
                    }
                },
                function () {
                    $(".modal-body").LoadingOverlay("hide");
            ...
            AjaxPost("../frmTienda.aspx/Editar", JSON.stringify(request),
                function (response) {
                    ...
                    if (response.estado) {
                        ...
                        swal("Mensaje", "No se pudo editar la Sede", "warning")
                    }
                },
                function () {
                    $(".modal-body").LoadingOverlay("hide");
