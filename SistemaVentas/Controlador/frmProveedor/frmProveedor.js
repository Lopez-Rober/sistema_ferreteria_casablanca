...
$('#tbProveedor tbody').on('click', 'button[class="btn btn-sm btn-danger"]', function () {
    ...
    swal({
        title: "Mensaje",
        text: "¿Esta seguro de eliminiar al Encargado?",
        type: "warning",
        ...
        AjaxPost("../frmProveedor.aspx/Eliminar", JSON.stringify(request),
            function (response) {
                if (response.estado) {
                    ...
                    swal("oops!", "No se pudo eliminar al Encargado", "warning")
                }
            },
            function () {
            },
            ...
            AjaxPost("../frmProveedor.aspx/Guardar", JSON.stringify(request),
                function (response) {
                    ...
                    if (response.estado) {
                        ...
                        swal("Mensaje", "No se pudo registrar al Encargado", "warning")
                    }
                },
                function () {
                    $(".modal-body").LoadingOverlay("hide");
            ...
            AjaxPost("../frmProveedor.aspx/Editar", JSON.stringify(request),
                function (response) {
                    ...
                    if (response.estado) {
                        ...
                        swal("Mensaje", "No se pudo editar al Encargado", "warning")
                    }
                },
                function () {
                    $(".modal-body").LoadingOverlay("hide");
